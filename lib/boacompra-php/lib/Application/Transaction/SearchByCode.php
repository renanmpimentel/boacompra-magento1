...
class SearchByCode
{
    ...
    public function __construct(Request $request)
    {
        ...
        try {
            $this->request->setQueryParams(null, null, null, null, null, null, null, null, null);
    ...
    private function generateQueryParams()
    {
        ...
        return '/' . $this->request->getCode() . '?' . urldecode(http_build_query($this->request->getQueryParams()));
    }
